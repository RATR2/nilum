...
public final class AssetClient {
    ...
    public static byte[] request(Socket socket, String assetId) throws IOException {
        NilumTcpFrames.writeFrame(socket.getOutputStream(), new AssetRequestPacket(assetId).encode());
