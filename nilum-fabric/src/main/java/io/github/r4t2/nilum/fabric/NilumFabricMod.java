...
public final class NilumFabricMod implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        PayloadTypeRegistry.playS2C().register(NilumItemDefinedAssetsPayload.TYPE, NilumItemDefinedAssetsPayload.CODEC);
        ...
        PayloadTypeRegistry.playS2C().register(NilumItemAnimationPlayPayload.TYPE, NilumItemAnimationPlayPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(NilumItemAnimationStopPayload.TYPE, NilumItemAnimationStopPayload.CODEC);
