...
public final class NilumBlocks {
    ...
    public static final ResourceKey<Block> BLOCK_KEY = ResourceKey.create(Registries.BLOCK, BLOCK_ID);
    ...
    public static void register() {
        BLOCK = Registry.register(BuiltInRegistries.BLOCK, BLOCK_KEY, new NilumBlock(NilumBlock.defaultProperties().setId(BLOCK_KEY)));
